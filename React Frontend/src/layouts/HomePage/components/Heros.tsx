        ...
        <div>
            <div className="d-none d-lg-block">
                <div className="row g-0 mt-5">
                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-cneter align-items-center">
                        <div className="ml-2">
                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                        <div className="ml-2">
                            ...
                            <p className="lead">
                                ...
                                for out Epic Read students! We are diligent about our book selection
