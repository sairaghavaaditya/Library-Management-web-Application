...
import { StarsReview } from "./StrarsReview";

export const LeaveAReview: React.FC<{submitReview:any}> = (props) => {
    const [starInput, setStarInput] = useState(0);
    const [displayInput,setDisplauInput] = useState(false);
    const [reviewDescription,setReviewDescription] = useState('');

    function starValue(value: number) {
        setStarInput(value);
        setDisplauInput(true);
    }
    return (
            ...
            {displayInput && 
                 <form method='POST' action='#'>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" id='submitReviewDescription' placeholder="Optinal"
